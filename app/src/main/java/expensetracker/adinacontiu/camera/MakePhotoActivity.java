...
public class MakePhotoActivity extends Activity {
    ...
    TextureView.SurfaceTextureListener textureListener = new CameraSurfaceTextureListener(this);
    ...
    protected void takePicture() {
        ...
        CameraHandler handler = new CameraHandler( manager, cameraDevice,
                textureView, windowManager, mBackgroundHandler, mBackgroundThread, this);
        handler.takePicture();
    }
